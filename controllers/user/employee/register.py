...
from dtos.requests.user.employee.register import RegisterEmployeeRequestDTO
...
from services.user.employee.register import UserEmployeeRegistrationService
...
class UserEmployeeRegisterstionController(IController):
    ...
    async def post(
        self, request: Request, request_payload: RegisterEmployeeRequestDTO
    ):
        ...
        try:
            ...
            service = UserEmployeeRegistrationService(
                urn=self.urn, user_urn=self.user_urn, api_name=self.api_name
            )
