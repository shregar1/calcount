...
@pytest.mark.asyncio
class TestMealAddRequestDTO(TestIV1MealAPIsRequestDTO):

    async def test_add_meal_requests_dto_all_field_valid(
        self,
        reference_number,
        meal_name,
        servings,
    ...
    async def test_add_meal_parameter_none_error(
        self,
        reference_number,
        meal_name,
        servings,
    ...
    async def test_add_meal_requests_dto_all_none_valid(self):
